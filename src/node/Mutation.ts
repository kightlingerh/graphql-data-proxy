...
export interface MutationNode<Result extends AnyBaseNode, Variables extends NodeVariables = {}, IsLocal extends boolean = false>
	extends BaseNode<
	...
	readonly __customCache?: CustomCache<
		TypeOfPartial<Result>,
		ExtractNodeDefinitionType<ExtractSubVariablesDefinition<Result> & ExtractVariablesDefinition<Result> & Variables>,
...
export interface DynamicMutationNodeConfig<Result extends AnyBaseNode, Variables extends NodeVariables, IsLocal extends boolean>
...
export function mutation<Item extends AnyBaseNode, Variables extends NodeVariables = {}, IsLocal extends boolean = false>(
	...
	return {
		tag: MUTATION_TAG,
		result,
		strict: getModel(result.strict, !!config?.isLocal, result.__hasTransformations.encoding, result.__hasTransformations.decoding),
		partial: getModel(result.partial, !!config?.isLocal, result.__hasTransformations.encoding, result.__hasTransformations.decoding),
