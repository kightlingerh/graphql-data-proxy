...
export const int: TaskDecoder<unknown, G.Int> =
	/*#__PURE__*/
	fromGuard(G.int, 'integer')

export const float: TaskDecoder<unknown, G.Float> =
	/*#__PURE__*/
	fromGuard(G.float, 'float')

export const boolean: TaskDecoder<unknown, boolean> = /*#__PURE__*/ fromGuard(G.boolean, 'boolean')

export const UnknownArray: TaskDecoder<unknown, Array<unknown>> = /*#__PURE__*/ fromGuard(G.UnknownArray, 'Array<unknown>')

export const UnknownRecord: TaskDecoder<unknown, Record<string, unknown>> = /*#__PURE__*/ fromGuard(G.UnknownRecord, 'Record<string, unknown>')
...
export const fromEither = <IL, IR, L, R>(l: TaskDecoder<IL, L>, r: TaskDecoder<IL, R>): TaskDecoder<IL | IR, E.Either<L, R>> =>
	pipe(TD.map<R, E.Either<L, R>>(E.right)(r as TaskDecoder<IL | IR, R>), TD.alt(() => TD.map<L, E.Either<L, R>>(E.left)(l as TaskDecoder<IL | IR, L>)))
...
export const map = (toPairs: (i: unknown) => Array<[unknown, unknown]>) => <K, A>(k: TaskDecoder<unknown, K>, a: TaskDecoder<unknown, A>) => fromMap(toPairs)(k, a)
