...
export const UnknownArray: TaskDecoder<Array<unknown>, Array<unknown>> = /*#__PURE__*/ fromGuard(G.UnknownArray, 'Array<unknown>')
...
export const nonEmptyArray = <A>(item: TaskDecoder<unknown, A>): TaskDecoder<unknown, NonEmptyArray<any>> => fromNonEmptyArray(item) as any;
