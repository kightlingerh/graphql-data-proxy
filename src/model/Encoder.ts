...
export { id, Encoder, array, type, partial, sum, lazy, nullable, OutputOf, tuple, record }
...
export const either = <OL, OR, L, R>(l: Encoder<OL, L>, r: Encoder<OR, R>): Encoder<OL | OR, Either<L, R>> => ({
...
export const nonEmptyArray = <O, A>(item: Encoder<O, A>): Encoder<Array<O>, NonEmptyArray<A>> => array(item) as any
